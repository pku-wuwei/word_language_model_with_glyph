...
--save /data/nfsdata/nlp/projects/glyph_lm_cnn1/ --model LSTM --emsize 1500 --dropout 0.2 --gpu_id 2 \
--nfeat 300 --nhid 1500 --nlayers 2 --lr 0.001 --epochs 500 --batch_size 200 --bptt 35 \
